...
func StartKVServer(servers []*labrpc.ClientEnd, me int, persister *raft.Persister, maxraftstate int) *KVServer {
	...
	//kv.bitcaskMachine, err = storage.OpenWithOptions(model.DefaultOptions)
	//
	//if err != nil {
	//	logrus.Info("open kv engine err:", err.Error())
	//	panic("open kv engine failed")
	//}
